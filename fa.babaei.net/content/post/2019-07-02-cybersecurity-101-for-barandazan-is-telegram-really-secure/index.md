...
لیست های تماس بسیار ارزشمند هستند. [به لطف آقای اسنودن ما می دانیم که آژانس امنیت ملی آمریکا چه زحمات و هزینه هایی را جهت سرقت لیست های تماس از پیام رسان ها متحمل شده است](https://web.archive.org/web/20190302162616/https://www.schneier.com/blog/archives/2013/10/nsa_harvesting.html). در تلفن های همراه، لیست تماس ها حتی بسیار باارزش ترند، زیرا تطابق دادن آن ها با هویت آدم ها در دنیای واقعی و مجازی، به حد بسیار احمقانه ای ساده است.
...
پرسیدن این سوال ضروری به نظر می رسد؛ تلگرام که ادعا می کند، احترام به حریم خصوصی و امنیت را سرلوحه کار خود قرار داده است، چرا مانند به عنوان مثال برنامه اسکایپ، به جای شماره تلفن قابلیت ثبت نام با یک آدرس ایمیل [یا حتی بدون آن](#wickr) را به شما نمی دهد؟
...
پیش تر از آن، در تاریخ ۲۰ اکتبر ۲۰۱۵، پاول دورُف با فاصله زمانی کوتاه در اکانت رسمی توییتر خود در دو توییت ([توییت اول](https://twitter.com/durov/status/656543684167651329)؛ [توییت دوم](https://twitter.com/durov/status/656551981226528768)) اذعان نموده که مقامات ایرانی خواستار جاسوسی از شهروندان خود شده اند:
...
براساس ادعاهای مطرح شده از سوی این منابع که ابدا توانایی تایید آن ها را ندارم، به طرقی خاص - که بازهم تاکید می نمایم، به دلیل حفظ امنیت جانی و رعایت اخلاق امکان بازگو نمودن آن وجود ندارد - نهادهای امنیتی موفق به بدست آوردن کلیدهای رمزنگاری تلگرام شده اند. از آن جایی که تلگرام به صورت پیش فرض از رمزنگاری سر تا سر استفاده نمی نمایند و این قابلیت در گروه ها و نسخه های وب و دسکتاپ غیر فعال می باشد، اگر این ادعا صحت داشته باشد، این به آن معنی است که بخش عمده ای از کاربران تلگرام با استفاده از [حملات مرد میانی](https://fa.wikipedia.org/wiki/%D8%AD%D9%85%D9%84%D9%87_%D9%85%D8%B1%D8%AF_%D9%85%DB%8C%D8%A7%D9%86%DB%8C) آسیب پذیر می باشند. البته ذکر این نکته ضروری است که به دلیل حجم بالای داده، و نیاز به توان پردازشی بسیار بالا جهت رمزگشایی، احتمالا امکان استفاده گسترده وجود نخواهد داشت. اما در موارد خاص و دست چین، یقینا در صورت صحت موضوع امکان پذیر است.
...
باز هم تاکید می نمایم که امکان تایید صحت هیچ یک از ادعاهای فوق را ندارم! تنها دلیل بازگو نمودن شنیده هایم، نشان دادن خطرات مربوط به تصمیمات پیش فرض تحمیلی به کاربران نظیر عدم رمزگذاری سر تا سر می باشد.
...
از آنجایی که مشکلات شنود و جاسوسی انبوه تنها مختص ایران نیست، متخصصین امر و کاربران علاقمند به حفظ حریم خصوصی،  به دنبال جایگزین برای نه تنها پیام رسان هایی نظیر واتس اپ، وایبر، پیام رسان فیسبوک، اسکایپ، لاین، تلگرام، [Threema](https://en.wikipedia.org/wiki/Threema)، [اسلک](https://fa.wikipedia.org/wiki/%D8%A7%D8%B3%D9%84%DA%A9_(%D9%86%D8%B1%D9%85%E2%80%8C%D8%A7%D9%81%D8%B2%D8%A7%D8%B1))، [دیسکورد](https://fa.wikipedia.org/wiki/%D8%AF%DB%8C%D8%B3%DA%A9%D9%88%D8%B1%D8%AF) یا حتی [فایرچت](https://fa.wikipedia.org/wiki/%D9%81%D8%A7%DB%8C%D8%B1%DA%86%D8%AA) که به دلیل کد بسته بودن احتمال شنود آن ها وجود دارد،  بلکه سایر سرویس ها و نرم افزارها، اقدام به ایجاد وب سایت ها و انجمن های متعدد به منظور بررسی و معرفی نرم افزارهای متن باز و تا حدود بسیار زیادی، واقعا امن نموده اند. از جمله این وب سایت ها می توان به [PRISM Break](https://prism-break.org/fa/)، [privacytools.io](https://www.privacytools.io/)، و یا [ThinkPrivacy](https://www.thinkprivacy.io/) اشاره نمود. همچنین سابردیت های [r/privacy](https://www.reddit.com/r/privacy/)، [r/privacytoolsIO](https://www.reddit.com/r/privacytoolsIO/) و [r/degoogle](https://www.reddit.com/r/degoogle/) در این زمینه ایجاد شده اند. به علاوه، لیست های مقایسه ای پیام رسان ها از نظر میزان امنیت و حفظ حریم خصوصی نظیر [Secure Messaging Apps Comparison](https://www.securemessagingapps.com/)، [Practical Application of EFF's Guide to Choosing a Messenger](https://securechatguide.org/effguide.html)، [ThinkPrivacy Messenger Comparison Chart](https://www.thinkprivacy.io/messengers.html) ایجاد شده اند.
...
به دلیل تحمیل تصمیم های امنیتی غلط به کاربران و انتخاب های پیش فرض امنیتی نادرست، مانند چت بدون رمزگذاری سر تا سر و یا سرهم نمودن یک پروتکل که منجر به یک محصول معیوب از نقطه نظر امنیت و حریم خصوصی می شود، تلگرام بهشت موعود برای هکرها و برنامه های نظارتی و جاسوسی دولت ها و نهادهای امنیتی شان است.
