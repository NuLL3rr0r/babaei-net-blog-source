...
tags = [ "Barandazan", "Censorship", "Cybersecurity", "Iran", "Islamic Republic Of Iran", "Reddit", "Social Media", "TED", "TED Talks", "TEDx", "Telegram", "Twitter" ]
toc = false
+++
...
<div style="margin: 2em 0">
<div style="max-width:854px"><div style="position:relative;height:0;padding-bottom:56.25%"><iframe src="https://embed.ted.com/talks/lang/fa/trita_parsi_iran_and_israel_peace_is_possible" width="854" height="480" style="position:absolute;left:0;top:0;width:100%;height:100%" frameborder="0" scrolling="no" allowfullscreen></iframe></div></div>
</div>

ابدا قصد پرداختن به گل واژه هایی که در این سخنرانی مطرح می شود را ندارم. اما تصمیم گرفتم ببینم آیا اعضا و یا سایر افراد مرتبط با نایاک سخنران تد یا تدکس هستند یا نه. با کمی جستجو دریافتم بخش قابل توجهی از این افراد سخنران تد یا تدکس بوده و یا هستند. به نظر می رسد که محبوبیت و اقبال بسیار بالای تد، آن را به یک رسانه تبلیغاتی بسیار خوب به عنوان پلتفرمی مناسب با انطعاف و قدرت بسیار بالای رسیدن به مخاطب غربی تبدیل می نماید.

به عنوان مثال، فمینیست ولایی [نگین فرساد](https://twitter.com/NeginFarsad) که در سخنرانی تد خود اعلام می نماید که مسلمان است (آیا یک زن مسلمان نباید حجاب داشته باشد؟) و سازنده یک مستند و تور استندآپ کمدی تحت عنوان [مسلمانان می آیند](https://twitter.com/MuslimsRComing) می باشد، سخنرانی فوریه ۲۰۱۶ او تحت عنوان [دسته بندی بسیار علمی متنفران](https://www.ted.com/talks/negin_farsad_a_highly_scientific_taxonomy_of_haters?language=fa) تا کنون <code>۱,۳۷۹,۹۲۴</code> بار دیده شده است:
...
{{< blockquote author="نگین فرساد" link="https://www.ted.com/talks/negin_farsad_a_highly_scientific_taxonomy_of_haters?language=fa" title="دسته بندی بسیار علمی متنفران" >}}
حال، سوال اینجا است:
...
و وقتی که می خندید، وارد حالت گشادگی می شوید.
...
خودش است! آن ها استاد این کار هستند.

[ماز جبرانی](https://twitter.com/MazJobrani) هم که استندآپ کمدین است، دو سخنرای تد به ترتیب در تاریخ های جولای ۲۰۱۰ و آوریل ۲۰۱۲ تحت عناوین [ماز جبرانی : آیا این یکی را درباره ایرانی-آمریکایی ها شنیده اید؟](https://www.ted.com/talks/maz_jobrani_make_jokes_not_bombs?language=fa) و [ماز جبرانی: یه عربستانی، یه هندی و یه ایرانی در کشور قطر به یک بار رفتند... ماز جبرانی: یه عربستانی، یه هندی و یه ایرانی رفتن به یه بار قطری...](https://www.ted.com/talks/maz_jobrani_a_saudi_an_indian_and_an_iranian_walk_into_a_qatari_bar?language=fa) دارد که به ترتیب <code>۵,۷۶۱,۸۵۰</code> و <code>۱۳,۷۷۳,۷۹۰</code> بار تا لحظه فعلی دیده شده اند:

<div style="margin: 2em 0">
<div style="max-width:854px"><div style="position:relative;height:0;padding-bottom:56.25%"><iframe src="https://embed.ted.com/talks/lang/fa/maz_jobrani_make_jokes_not_bombs" width="854" height="480" style="position:absolute;left:0;top:0;width:100%;height:100%" frameborder="0" scrolling="no" allowfullscreen></iframe></div></div>
</div>

<div style="margin: 2em 0">
<div style="max-width:854px"><div style="position:relative;height:0;padding-bottom:56.25%"><iframe src="https://embed.ted.com/talks/lang/fa/maz_jobrani_a_saudi_an_indian_and_an_iranian_walk_into_a_qatari_bar" width="854" height="480" style="position:absolute;left:0;top:0;width:100%;height:100%" frameborder="0" scrolling="no" allowfullscreen></iframe></div></div>
</div>

در سخنرانی اول، به گفته خودش، [ماز جبرانی](https://fa.wikipedia.org/wiki/%D9%85%D8%A7%D8%B2_%D8%AC%D8%A8%D8%B1%D8%A7%D9%86%DB%8C) یکی از اعضای پایه گذار "تور کمدی محور شیطانی بوده" است. یک سخنرانی دیگر بر روی وب سایت تد تحت عنوان [تور کمدی خاورميانه اي محور شرارت](https://www.ted.com/talks/jamil_abu_wardeh_bringing_comedy_to_the_axis_of_evil?language=fa) توسط [تهیه کننده](https://web.archive.org/web/20190705174453/https://www.revolvy.com/page/Axis-of-Evil-Comedy-Tour) این تور یعنی [جميل ابو ورده](https://twitter.com/jamiltv)، به تاریخ جولای ۲۰۱۰ وجود دارد که <code>۱,۰۹۶,۰۰۷</code> بار دیده شده است:

<div style="margin: 2em 0">
<div style="max-width:854px"><div style="position:relative;height:0;padding-bottom:56.25%"><iframe src="https://embed.ted.com/talks/lang/fa/jamil_abu_wardeh_bringing_comedy_to_the_axis_of_evil" width="854" height="480" style="position:absolute;left:0;top:0;width:100%;height:100%" frameborder="0" scrolling="no" allowfullscreen></iframe></div></div>
</div>
...
{{< figure src="/blog/islamic-republic-global-propaganda-campaign-ted-niac/niac-event-shirin-neshat-1.png" alt="اعلانی در وب سایت رسمی نایاک مربوط به حضور خانم شیرین نشاط به عنوان مهمان ویژه در رخداد جمع آوری کمک مالی نایاک" title="اعلانی در وب سایت رسمی نایاک مربوط به حضور خانم شیرین نشاط به عنوان مهمان ویژه در رخداد جمع آوری کمک مالی نایاک" >}}

{{< figure src="/blog/islamic-republic-global-propaganda-campaign-ted-niac/niac-event-shirin-neshat-2.png" alt="اعلانی در وب سایت رسمی نایاک مربوط به حضور خانم شیرین نشاط در رخداد جمع آوری کمک مالی نایاک" title="اعلانی در وب سایت رسمی نایاک مربوط به حضور خانم شیرین نشاط در رخداد جمع آوری کمک مالی نایاک" >}}
...
خوشحال خواهم شد که نظرات خود در مورد محتوای ویدیوهای فوق را با من به اشتراک بگذارید؛ و یا حتی اگر سخنرانی های تد یا تدکس دیگری از اعضای نایاک یا وابستگان آن سراغ دارید، از به اشتراک گذاری آن ها استقبال می نمایم.
