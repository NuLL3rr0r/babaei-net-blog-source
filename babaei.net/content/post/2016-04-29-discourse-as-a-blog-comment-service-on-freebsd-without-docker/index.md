...
{{< codeblock lang="" title="/usr/local/pgsql/data/pg_hba.conf" >}}
...
{{< codeblock lang="" title="config/database.yml" >}}
...
{{< codeblock lang="" title="config/discourse_defaults.conf" >}}
#
...
{{< codeblock lang="" title="/home/discourse/discourse/config/discourse.conf" >}}
# Database
db_pool = 12
...
{{< codeblock lang="" title="config/multisite.yml.production-sample" >}}
mlp:
  adapter: postgresql
...
{{< codeblock lang="" title="/home/discourse/discourse/config/multisite.yml" >}}
...
{{< codeblock lang="" title="/home/discourse/cron/server.sh" >}}
#!/bin/sh
...
{{< codeblock lang="" title="crontab -e -u discourse" >}}
SHELL=/bin/sh
