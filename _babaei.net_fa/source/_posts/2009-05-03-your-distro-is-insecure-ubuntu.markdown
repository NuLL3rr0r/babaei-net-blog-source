...
{% img imgCenter ./2009-05-03-your-distro-is-insecure-ubuntu_001.jpg 603 313 'تصویر ۱: تنظیم نام های کاربری و کلمات عبور' 'تصویر ۱: تنظیم نام های کاربری و کلمات عبور' %}
